...
# # Remove commas from 'A_MEDIAN' and convert to numeric
...
# filtered_df = filtered_df[~filtered_df['State'].isin(['Puerto Rico', 'Guam', 'Virgin Islands', 'District of Columbia'])]
